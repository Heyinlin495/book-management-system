...
const handleLogin = async () => {
  ...
  try {
    await userStore.adminLogin(username.value, password.value, captchaCode.value, captchaKey.value)
    router.push('/')
  } catch (error) {
